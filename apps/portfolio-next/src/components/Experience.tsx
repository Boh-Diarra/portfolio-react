...
const professionalExperience: TimelineItemProps[] = [
  {
    date: 'Mai 2025',
    title: 'Projet Capstone - Application Restaurant Little Lemon',
    subtitle: 'Meta (Coursera) - Certificat Professionnel Développeur Front-End',
    description: `**Réalisations principales :**\n• Développement d'une application web complète pour le restaurant fictif Little Lemon\n• Système de commande en ligne avec panier d'achat interactif et gestion des articles\n• Module de réservation de tables avec calendrier dynamique et gestion des créneaux\n• Interface de gestion de menu avec filtres avancés et recherche intelligente\n• Design responsive optimisé pour mobile et desktop avec accessibilité web\n• Technologies : React, JavaScript, CSS3, HTML5, APIs REST, State Management\nBénéfice : Démonstration pratique des compétences front-end acquises avec un projet complet et fonctionnel`,
    siteUrl: 'https://github.com/Boh-Diarra/little-lemon', // Remplacer par l'URL réelle si disponible
  },
  {
  ...
  },
  {
    ...
    description: `**Réalisations principales :**\n• Supervision proactive des infrastructures informatiques, réduction de 30% des incidents critiques\n• Formation et accompagnement de plus de 20 utilisateurs pour booster leur productivité (+40%)\n• Mise en œuvre de procédures de sécurité, diminution de 25% des vulnérabilités système\n• Analyses techniques pour optimiser les performances (+15%)\n• Résultat : amélioration de la fiabilité et de la satisfaction des équipes`,
