  ...
  return (
    <section id="portfolio" className="bg-white dark:bg-gray-900 py-16 transition-colors">
      <div className="container mx-auto px-6 sm:px-4 xs:px-2 max-w-screen-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 mt-12">
          {filteredItems.map((item, index) => (
            <Tilt
              ...
              perspective={1200}
              gyroscope={true}
              className="portfolio-item group card-base card-orange-shadow glassmorphism fade-in-start hover:ring-1 hover:ring-[#FD9800] transition-all duration-300 rounded-lg shadow-lg p-4 sm:p-8 min-h-[320px] bg-white dark:bg-gray-800"
            >
